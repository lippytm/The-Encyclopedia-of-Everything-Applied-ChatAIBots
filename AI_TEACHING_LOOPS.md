...
2. Create a repo-based lesson or walkthrough
3. Build a small experiment or example
...
- teach with examples, not only descriptions
- document failed paths as lessons learned
